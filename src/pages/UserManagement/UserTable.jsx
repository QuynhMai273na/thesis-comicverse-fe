    ...
    <div className="h-full w-full bg-white shadow-md rounded-lg">
      <div className="p-6 border-b">
        <div className="mb-8 flex items-center justify-between gap-8">
          <div>
            <h1 className="text-2xl font-semibold text-gray-700">Users Overview</h1>
              ...
              {users.map((user, index) => {
                ...
                return (
                  <tr key={user.userID}>
                    ...
                    <td className={classes}>
                      <span className="text-gray-700">{new Date(user.assignAt).toLocaleDateString()}</span>
                    </td>
                    <td className={classes}>
                      <span className="text-gray-700">{new Date(user.deadline).toLocaleDateString()}</span>
                    </td>
                    <td className={classes}>
